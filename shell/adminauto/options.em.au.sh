...
curl "https://futsseapi.eastmoney.com/list/option/151?orderBy=zdf&sort=desc&pageSize=300&pageIndex=0&token=58b2fa8f54638b60b87d69b31969089c&field=dm%2Csc%2Cname%2Cp%2Czsjd%2Czde%2Czdf%2Cf152%2Cvol%2Ccje%2Cccl%2Cxqj%2Csyr%2Crz%2Czjsj%2Co&variety=3&_=1703047292580" | jq '.list' > options.json
...
do
	...
	if [[ $instId == *P* ]]
	then
		StrikePrice=`echo $instId | awk -F P '{print $2}'`
		OptionsType=1
	else
		StrikePrice=`echo $instId | awk -F C '{print $2}'`
		OptionsType=2
	fi
