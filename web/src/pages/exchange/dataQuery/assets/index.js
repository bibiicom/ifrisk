    ...
    return [
      {
        ...
        style: { width: 140 },
        render: data => data.Currency === '' ? intl.get('total_assets') : data.Currency
      },
      {
        key: 'valuation',
        title: intl.get('valuation'),
        style: { width: 200 },
        render: data => {
      ...
      },
      {
        ...
        style: { width: 280 },
        render: data => {
          if(data?.SettlementGroup==='')return data?.CurrValue || 0
      ...
      },
      {
        ...
        render: data => (
          <Row
            style={{ justifyContent: 'flex-end' }}>
            {data.Currency?.toUpperCase() === 'USDT' && (
              <Button
                className="button"
                type="tertiary"
                size="small"
