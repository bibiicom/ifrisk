#ifndef __CFastWorker_H__
#define __CFastWorker_H__
...
#define WorkerTypeFast 'F'

class CFastWorker :public CWorkerInterface
{
public:
	CFastWorker(CExchangeIDType ExchangeID, CInstrumentIDType InstrumentID, CWorkerCallback *pMarketMaker);
	~CFastWorker();
