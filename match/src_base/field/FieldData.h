...
public:
	...
	{
		m_Describe.SetupMember(Action,(int)((char *)&Action-(char *)this),"Action",sizeof(Action),"Action","A",0);
		m_Describe.SetupMember(TopicID,(int)((char *)&TopicID-(char *)this),"TopicID",sizeof(TopicID),"TopicID","T",0);
		m_Describe.SetupMember(Index,(int)((char *)&Index-(char *)this),"Index",sizeof(Index),"Index","I",0);
		m_Describe.SetupMember(ResumeNo,(int)((char *)&ResumeNo-(char *)this),"ResumeNo",sizeof(ResumeNo),"ResumeNo","R",0);
		m_Describe.SetupMember(BusinessNo,(int)((char *)&BusinessNo-(char *)this),"BusinessNo",sizeof(BusinessNo),"BusinessNo","B",0);
...
public:
	...
	void DescribeMembers()
	{
		m_Describe.SetupMember(MemberID,(int)((char *)&MemberID-(char *)this),"MemberID",sizeof(MemberID),"MemberID","M",0);
		m_Describe.SetupMember(TradeUnitID,(int)((char *)&TradeUnitID-(char *)this),"TradeUnitID",sizeof(TradeUnitID),"TradeUnitID","T",0);
		m_Describe.SetupMember(AccountID,(int)((char *)&AccountID-(char *)this),"AccountID",sizeof(AccountID),"AccountID","A",0);
		m_Describe.SetupMember(LocalID,(int)((char *)&LocalID-(char *)this),"LocalID",sizeof(LocalID),"LocalID","L",0);
		m_Describe.SetupMember(ExchangeID,(int)((char *)&ExchangeID-(char *)this),"ExchangeID",sizeof(ExchangeID),"ExchangeID","E",0);
		m_Describe.SetupMember(InstrumentID,(int)((char *)&InstrumentID-(char *)this),"InstrumentID",sizeof(InstrumentID),"InstrumentID","I",0);
		m_Describe.SetupMember(OrderPriceType,(int)((char *)&OrderPriceType-(char *)this),"OrderPriceType",sizeof(OrderPriceType),"OrderPriceType","PT",0);
		m_Describe.SetupMember(Direction,(int)((char *)&Direction-(char *)this),"Direction",sizeof(Direction),"Direction","D",0);
		m_Describe.SetupMember(OffsetFlag,(int)((char *)&OffsetFlag-(char *)this),"OffsetFlag",sizeof(OffsetFlag),"OffsetFlag","O",0);
		m_Describe.SetupMember(Price,(int)((char *)&Price-(char *)this),"Price",sizeof(Price),"Price","P",15);
		m_Describe.SetupMember(Volume,(int)((char *)&Volume-(char *)this),"Volume",sizeof(Volume),"Volume","V",10);
		m_Describe.SetupMember(VolumeDisplay,(int)((char *)&VolumeDisplay-(char *)this),"VolumeDisplay",sizeof(VolumeDisplay),"VolumeDisplay","D",10);
		m_Describe.SetupMember(VolumeMode,(int)((char *)&VolumeMode-(char *)this),"VolumeMode",sizeof(VolumeMode),"VolumeMode","VM",0);
		m_Describe.SetupMember(Cost,(int)((char *)&Cost-(char *)this),"Cost",sizeof(Cost),"Cost","C",10);
		m_Describe.SetupMember(OrderType,(int)((char *)&OrderType-(char *)this),"OrderType",sizeof(OrderType),"OrderType","OT",0);
		m_Describe.SetupMember(GTDTime,(int)((char *)&GTDTime-(char *)this),"GTDTime",sizeof(GTDTime),"GTDTime","GT",3);
		m_Describe.SetupMember(MinVolume,(int)((char *)&MinVolume-(char *)this),"MinVolume",sizeof(MinVolume),"MinVolume","MV",10);
		m_Describe.SetupMember(BusinessType,(int)((char *)&BusinessType-(char *)this),"BusinessType",sizeof(BusinessType),"BusinessType","BT",0);
		m_Describe.SetupMember(BusinessValue,(int)((char *)&BusinessValue-(char *)this),"BusinessValue",sizeof(BusinessValue),"BusinessValue","BV",0);
		m_Describe.SetupMember(CloseOrderID,(int)((char *)&CloseOrderID-(char *)this),"CloseOrderID",sizeof(CloseOrderID),"CloseOrderID","CI",0);
		...
		m_Describe.SetupMember(Remark,(int)((char *)&Remark-(char *)this),"Remark",sizeof(Remark),"Remark","R",0);
		...
		m_Describe.SetupMember(APPID,(int)((char *)&APPID-(char *)this),"APPID",sizeof(APPID),"APPID","APPID",0);
		m_Describe.SetupMember(PositionID,(int)((char *)&PositionID-(char *)this),"PositionID",sizeof(PositionID),"PositionID","B",0);
...
public:
	...
	void DescribeMembers()
	{
		...
		m_Describe.SetupMember(TradeUnitID,(int)((char *)&TradeUnitID-(char *)this),"TradeUnitID",sizeof(TradeUnitID),"TradeUnitID","T",0);
		m_Describe.SetupMember(AccountID,(int)((char *)&AccountID-(char *)this),"AccountID",sizeof(AccountID),"AccountID","A",0);
		m_Describe.SetupMember(UserID,(int)((char *)&UserID-(char *)this),"UserID",sizeof(UserID),"UserID","U",0);
		m_Describe.SetupMember(LocalID,(int)((char *)&LocalID-(char *)this),"LocalID",sizeof(LocalID),"LocalID","L",0);
		m_Describe.SetupMember(ExchangeID,(int)((char *)&ExchangeID-(char *)this),"ExchangeID",sizeof(ExchangeID),"ExchangeID","E",0);
		m_Describe.SetupMember(InstrumentID,(int)((char *)&InstrumentID-(char *)this),"InstrumentID",sizeof(InstrumentID),"InstrumentID","I",0);
		m_Describe.SetupMember(OrderPriceType,(int)((char *)&OrderPriceType-(char *)this),"OrderPriceType",sizeof(OrderPriceType),"OrderPriceType","PT",0);
...
public:
	...
	void DescribeMembers()
	{
		m_Describe.SetupMember(ExchangeID,(int)((char *)&ExchangeID-(char *)this),"ExchangeID",sizeof(ExchangeID),"ExchangeID","X",0);
		m_Describe.SetupMember(InstrumentID,(int)((char *)&InstrumentID-(char *)this),"InstrumentID",sizeof(InstrumentID),"InstrumentID","I",0);
		m_Describe.SetupMember(ProductGroup,(int)((char *)&ProductGroup-(char *)this),"ProductGroup",sizeof(ProductGroup),"ProductGroup","G",0);
		m_Describe.SetupMember(UpdateTime,(int)((char *)&UpdateTime-(char *)this),"UpdateTime",sizeof(UpdateTime),"UpdateTime","U",3);
		m_Describe.SetupMember(UpperLimitPrice,(int)((char *)&UpperLimitPrice-(char *)this),"UpperLimitPrice",sizeof(UpperLimitPrice),"UpperLimitPrice","C",15);
		m_Describe.SetupMember(LowerLimitPrice,(int)((char *)&LowerLimitPrice-(char *)this),"LowerLimitPrice",sizeof(LowerLimitPrice),"LowerLimitPrice","F",15);
		m_Describe.SetupMember(UnderlyingPrice,(int)((char *)&UnderlyingPrice-(char *)this),"UnderlyingPrice",sizeof(UnderlyingPrice),"UnderlyingPrice","D",15);
		m_Describe.SetupMember(MarkedPrice,(int)((char *)&MarkedPrice-(char *)this),"MarkedPrice",sizeof(MarkedPrice),"MarkedPrice","M",15);
		m_Describe.SetupMember(PositionFeeRate,(int)((char *)&PositionFeeRate-(char *)this),"PositionFeeRate",sizeof(PositionFeeRate),"PositionFeeRate","R",10);
		m_Describe.SetupMember(HighestPrice,(int)((char *)&HighestPrice-(char *)this),"HighestPrice",sizeof(HighestPrice),"HighestPrice","H",15);
		m_Describe.SetupMember(LowestPrice,(int)((char *)&LowestPrice-(char *)this),"LowestPrice",sizeof(LowestPrice),"LowestPrice","L",15);
		m_Describe.SetupMember(LastPrice,(int)((char *)&LastPrice-(char *)this),"LastPrice",sizeof(LastPrice),"LastPrice","N",15);
		m_Describe.SetupMember(Volume,(int)((char *)&Volume-(char *)this),"Volume",sizeof(Volume),"Volume","V",8);
		m_Describe.SetupMember(Turnover,(int)((char *)&Turnover-(char *)this),"Turnover",sizeof(Turnover),"Turnover","T",8);
		m_Describe.SetupMember(OpenInterest,(int)((char *)&OpenInterest-(char *)this),"OpenInterest",sizeof(OpenInterest),"OpenInterest","P",10);
		m_Describe.SetupMember(SettlementPrice,(int)((char *)&SettlementPrice-(char *)this),"SettlementPrice",sizeof(SettlementPrice),"SettlementPrice","S",15);
		m_Describe.SetupMember(OpenPrice,(int)((char *)&OpenPrice-(char *)this),"OpenPrice",sizeof(OpenPrice),"OpenPrice","O",15);
		m_Describe.SetupMember(InstrumentStatus,(int)((char *)&InstrumentStatus-(char *)this),"InstrumentStatus",sizeof(InstrumentStatus),"InstrumentStatus","B",0);
		m_Describe.SetupMember(PrePositionFeeRate,(int)((char *)&PrePositionFeeRate-(char *)this),"PrePositionFeeRate",sizeof(PrePositionFeeRate),"PrePositionFeeRate","E",10);
		m_Describe.SetupMember(PositionFeeTime,(int)((char *)&PositionFeeTime-(char *)this),"PositionFeeTime",sizeof(PositionFeeTime),"PositionFeeTime","PF",3);
		m_Describe.SetupMember(BidPrice1,(int)((char *)&BidPrice1-(char *)this),"BidPrice1",sizeof(BidPrice1),"BidPrice1","BP1",15);
		m_Describe.SetupMember(AskPrice1,(int)((char *)&AskPrice1-(char *)this),"AskPrice1",sizeof(AskPrice1),"AskPrice1","AP1",15);
		m_Describe.SetupMember(HighestPrice24,(int)((char *)&HighestPrice24-(char *)this),"HighestPrice24",sizeof(HighestPrice24),"HighestPrice24","H2",15);
		m_Describe.SetupMember(LowestPrice24,(int)((char *)&LowestPrice24-(char *)this),"LowestPrice24",sizeof(LowestPrice24),"LowestPrice24","L2",15);
		m_Describe.SetupMember(Volume24,(int)((char *)&Volume24-(char *)this),"Volume24",sizeof(Volume24),"Volume24","V2",8);
		m_Describe.SetupMember(Turnover24,(int)((char *)&Turnover24-(char *)this),"Turnover24",sizeof(Turnover24),"Turnover24","T2",8);
		m_Describe.SetupMember(OpenPrice24,(int)((char *)&OpenPrice24-(char *)this),"OpenPrice24",sizeof(OpenPrice24),"OpenPrice24","O2",15);
	}
...
public:
	...
	void DescribeMembers()
	{
		...
		m_Describe.SetupMember(UpdateTime,(int)((char *)&UpdateTime-(char *)this),"UpdateTime",sizeof(UpdateTime),"UpdateTime","U",3);
		m_Describe.SetupMember(BidPrice1,(int)((char *)&BidPrice1-(char *)this),"BidPrice1",sizeof(BidPrice1),"BidPrice1","BP1",15);
		m_Describe.SetupMember(BidVolume1,(int)((char *)&BidVolume1-(char *)this),"BidVolume1",sizeof(BidVolume1),"BidVolume1","BV1",10);
		m_Describe.SetupMember(AskPrice1,(int)((char *)&AskPrice1-(char *)this),"AskPrice1",sizeof(AskPrice1),"AskPrice1","AP1",15);
		m_Describe.SetupMember(AskVolume1,(int)((char *)&AskVolume1-(char *)this),"AskVolume1",sizeof(AskVolume1),"AskVolume1","AV1",10);
		m_Describe.SetupMember(BidPrice2,(int)((char *)&BidPrice2-(char *)this),"BidPrice2",sizeof(BidPrice2),"BidPrice2","BP2",15);
		m_Describe.SetupMember(BidVolume2,(int)((char *)&BidVolume2-(char *)this),"BidVolume2",sizeof(BidVolume2),"BidVolume2","BV2",10);
		m_Describe.SetupMember(AskPrice2,(int)((char *)&AskPrice2-(char *)this),"AskPrice2",sizeof(AskPrice2),"AskPrice2","AP2",15);
		m_Describe.SetupMember(AskVolume2,(int)((char *)&AskVolume2-(char *)this),"AskVolume2",sizeof(AskVolume2),"AskVolume2","AV2",10);
		m_Describe.SetupMember(BidPrice3,(int)((char *)&BidPrice3-(char *)this),"BidPrice3",sizeof(BidPrice3),"BidPrice3","BP3",15);
		m_Describe.SetupMember(BidVolume3,(int)((char *)&BidVolume3-(char *)this),"BidVolume3",sizeof(BidVolume3),"BidVolume3","BV3",10);
		m_Describe.SetupMember(AskPrice3,(int)((char *)&AskPrice3-(char *)this),"AskPrice3",sizeof(AskPrice3),"AskPrice3","AP3",15);
		m_Describe.SetupMember(AskVolume3,(int)((char *)&AskVolume3-(char *)this),"AskVolume3",sizeof(AskVolume3),"AskVolume3","AV3",10);
		m_Describe.SetupMember(BidPrice4,(int)((char *)&BidPrice4-(char *)this),"BidPrice4",sizeof(BidPrice4),"BidPrice4","BP4",15);
		m_Describe.SetupMember(BidVolume4,(int)((char *)&BidVolume4-(char *)this),"BidVolume4",sizeof(BidVolume4),"BidVolume4","BV4",10);
		m_Describe.SetupMember(AskPrice4,(int)((char *)&AskPrice4-(char *)this),"AskPrice4",sizeof(AskPrice4),"AskPrice4","AP4",15);
		m_Describe.SetupMember(AskVolume4,(int)((char *)&AskVolume4-(char *)this),"AskVolume4",sizeof(AskVolume4),"AskVolume4","AV4",10);
		m_Describe.SetupMember(BidPrice5,(int)((char *)&BidPrice5-(char *)this),"BidPrice5",sizeof(BidPrice5),"BidPrice5","BP5",15);
		m_Describe.SetupMember(BidVolume5,(int)((char *)&BidVolume5-(char *)this),"BidVolume5",sizeof(BidVolume5),"BidVolume5","BV5",10);
		m_Describe.SetupMember(AskPrice5,(int)((char *)&AskPrice5-(char *)this),"AskPrice5",sizeof(AskPrice5),"AskPrice5","AP5",15);
		m_Describe.SetupMember(AskVolume5,(int)((char *)&AskVolume5-(char *)this),"AskVolume5",sizeof(AskVolume5),"AskVolume5","AV5",10);
	}
...
public:
	...
	void DescribeMembers()
	{
		...
		m_Describe.SetupMember(AskPrice5,(int)((char *)&AskPrice5-(char *)this),"AskPrice5",sizeof(AskPrice5),"AskPrice5","AP5",15);
		m_Describe.SetupMember(AskVolume5,(int)((char *)&AskVolume5-(char *)this),"AskVolume5",sizeof(AskVolume5),"AskVolume5","AV5",10);
		m_Describe.SetupMember(BidPrice6,(int)((char *)&BidPrice6-(char *)this),"BidPrice6",sizeof(BidPrice6),"BidPrice6","BP6",15);
		m_Describe.SetupMember(BidVolume6,(int)((char *)&BidVolume6-(char *)this),"BidVolume6",sizeof(BidVolume6),"BidVolume6","BV6",10);
		m_Describe.SetupMember(AskPrice6,(int)((char *)&AskPrice6-(char *)this),"AskPrice6",sizeof(AskPrice6),"AskPrice6","AP6",15);
		m_Describe.SetupMember(AskVolume6,(int)((char *)&AskVolume6-(char *)this),"AskVolume6",sizeof(AskVolume6),"AskVolume6","AV6",10);
		m_Describe.SetupMember(BidPrice7,(int)((char *)&BidPrice7-(char *)this),"BidPrice7",sizeof(BidPrice7),"BidPrice7","BP7",15);
		m_Describe.SetupMember(BidVolume7,(int)((char *)&BidVolume7-(char *)this),"BidVolume7",sizeof(BidVolume7),"BidVolume7","BV7",10);
		m_Describe.SetupMember(AskPrice7,(int)((char *)&AskPrice7-(char *)this),"AskPrice7",sizeof(AskPrice7),"AskPrice7","AP7",15);
		m_Describe.SetupMember(AskVolume7,(int)((char *)&AskVolume7-(char *)this),"AskVolume7",sizeof(AskVolume7),"AskVolume7","AV7",10);
		m_Describe.SetupMember(BidPrice8,(int)((char *)&BidPrice8-(char *)this),"BidPrice8",sizeof(BidPrice8),"BidPrice8","BP8",15);
		m_Describe.SetupMember(BidVolume8,(int)((char *)&BidVolume8-(char *)this),"BidVolume8",sizeof(BidVolume8),"BidVolume8","BV8",10);
		m_Describe.SetupMember(AskPrice8,(int)((char *)&AskPrice8-(char *)this),"AskPrice8",sizeof(AskPrice8),"AskPrice8","AP8",15);
		m_Describe.SetupMember(AskVolume8,(int)((char *)&AskVolume8-(char *)this),"AskVolume8",sizeof(AskVolume8),"AskVolume8","AV8",10);
		m_Describe.SetupMember(BidPrice9,(int)((char *)&BidPrice9-(char *)this),"BidPrice9",sizeof(BidPrice9),"BidPrice9","BP9",15);
		m_Describe.SetupMember(BidVolume9,(int)((char *)&BidVolume9-(char *)this),"BidVolume9",sizeof(BidVolume9),"BidVolume9","BV9",10);
		m_Describe.SetupMember(AskPrice9,(int)((char *)&AskPrice9-(char *)this),"AskPrice9",sizeof(AskPrice9),"AskPrice9","AP9",15);
		m_Describe.SetupMember(AskVolume9,(int)((char *)&AskVolume9-(char *)this),"AskVolume9",sizeof(AskVolume9),"AskVolume9","AV9",10);
		m_Describe.SetupMember(BidPrice10,(int)((char *)&BidPrice10-(char *)this),"BidPrice10",sizeof(BidPrice10),"BidPrice10","BP10",15);
		m_Describe.SetupMember(BidVolume10,(int)((char *)&BidVolume10-(char *)this),"BidVolume10",sizeof(BidVolume10),"BidVolume10","BV10",10);
		m_Describe.SetupMember(AskPrice10,(int)((char *)&AskPrice10-(char *)this),"AskPrice10",sizeof(AskPrice10),"AskPrice10","AP10",15);
		m_Describe.SetupMember(AskVolume10,(int)((char *)&AskVolume10-(char *)this),"AskVolume10",sizeof(AskVolume10),"AskVolume10","AV10",10);
	}
...
public:
	...
	void DescribeMembers()
	{
		...
		m_Describe.SetupMember(ProductGroup,(int)((char *)&ProductGroup-(char *)this),"ProductGroup",sizeof(ProductGroup),"ProductGroup","G",0);
		m_Describe.SetupMember(UpdateTime,(int)((char *)&UpdateTime-(char *)this),"UpdateTime",sizeof(UpdateTime),"UpdateTime","U",3);
		m_Describe.SetupMember(PreClosePrice,(int)((char *)&PreClosePrice-(char *)this),"PreClosePrice",sizeof(PreClosePrice),"PreClosePrice","",15);
		m_Describe.SetupMember(PreSettlementPrice,(int)((char *)&PreSettlementPrice-(char *)this),"PreSettlementPrice",sizeof(PreSettlementPrice),"PreSettlementPrice","",15);
		m_Describe.SetupMember(PreOpenInterest,(int)((char *)&PreOpenInterest-(char *)this),"PreOpenInterest",sizeof(PreOpenInterest),"PreOpenInterest","",10);
		m_Describe.SetupMember(PrePositionFeeRate,(int)((char *)&PrePositionFeeRate-(char *)this),"PrePositionFeeRate",sizeof(PrePositionFeeRate),"PrePositionFeeRate","",10);
		m_Describe.SetupMember(ClosePrice,(int)((char *)&ClosePrice-(char *)this),"ClosePrice",sizeof(ClosePrice),"ClosePrice","ClosePrice",15);
		m_Describe.SetupMember(PositionFeeTime,(int)((char *)&PositionFeeTime-(char *)this),"PositionFeeTime",sizeof(PositionFeeTime),"PositionFeeTime","PF",3);
...
public:
	...
	void DescribeMembers()
	{
		m_Describe.SetupMember(TradeID,(int)((char *)&TradeID-(char *)this),"TradeID",sizeof(TradeID),"TradeID","",0);
		m_Describe.SetupMember(ExchangeID,(int)((char *)&ExchangeID-(char *)this),"ExchangeID",sizeof(ExchangeID),"ExchangeID","",0);
		m_Describe.SetupMember(InstrumentID,(int)((char *)&InstrumentID-(char *)this),"InstrumentID",sizeof(InstrumentID),"InstrumentID","",0);
		m_Describe.SetupMember(Direction,(int)((char *)&Direction-(char *)this),"Direction",sizeof(Direction),"Direction","D",0);
		m_Describe.SetupMember(Price,(int)((char *)&Price-(char *)this),"Price",sizeof(Price),"Price","P",15);
		m_Describe.SetupMember(Volume,(int)((char *)&Volume-(char *)this),"Volume",sizeof(Volume),"Volume","V",10);
		m_Describe.SetupMember(InsertTime,(int)((char *)&InsertTime-(char *)this),"InsertTime",sizeof(InsertTime),"InsertTime","I",3);
	}
...
public:
	...
	void DescribeMembers()
	{
		m_Describe.SetupMember(TopicID,(int)((char *)&TopicID-(char *)this),"TopicID",sizeof(TopicID),"TopicID","T",0);
		m_Describe.SetupMember(MemberID,(int)((char *)&MemberID-(char *)this),"MemberID",sizeof(MemberID),"MemberID","MemberID",0);
		m_Describe.SetupMember(PrivateBase,(int)((char *)&PrivateBase-(char *)this),"PrivateBase",sizeof(PrivateBase),"PrivateBase","P",0);
	}
...
public:
	...
	void DescribeMembers()
	{
		...
		m_Describe.SetupMember(Price,(int)((char *)&Price-(char *)this),"Price",sizeof(Price),"Price","P",15);
		m_Describe.SetupMember(Volume,(int)((char *)&Volume-(char *)this),"Volume",sizeof(Volume),"Volume","V",10);
		m_Describe.SetupMember(Orders,(int)((char *)&Orders-(char *)this),"Orders",sizeof(Orders),"Orders","",0);
		m_Describe.SetupMember(BusinessNo,(int)((char *)&BusinessNo-(char *)this),"BusinessNo",sizeof(BusinessNo),"","",0);
		m_Describe.SetupMember(TrueVolume,(int)((char *)&TrueVolume-(char *)this),"TrueVolume",sizeof(TrueVolume),"","",10);
		m_Describe.SetupMember(Tick,(int)((char *)&Tick-(char *)this),"Tick",sizeof(Tick),"Tick","",15);
		m_Describe.SetupMember(SubIndex,(int)((char *)&SubIndex-(char *)this),"SubIndex",sizeof(SubIndex),"","",0);
	}
...
public:
	...
	void DescribeMembers()
	{
		...
		m_Describe.SetupMember(HighestPrice,(int)((char *)&HighestPrice-(char *)this),"HighestPrice",sizeof(HighestPrice),"HighestPrice","H",15);
		m_Describe.SetupMember(LowestPrice,(int)((char *)&LowestPrice-(char *)this),"LowestPrice",sizeof(LowestPrice),"LowestPrice","L",15);
		m_Describe.SetupMember(ClosePrice,(int)((char *)&ClosePrice-(char *)this),"ClosePrice",sizeof(ClosePrice),"ClosePrice","C",15);
		m_Describe.SetupMember(Volume,(int)((char *)&Volume-(char *)this),"Volume",sizeof(Volume),"Volume","V",8);
		m_Describe.SetupMember(Turnover,(int)((char *)&Turnover-(char *)this),"Turnover",sizeof(Turnover),"Turnover","T",8);
	}
...
public:
	...
	void DescribeMembers()
	{
		m_Describe.SetupMember(SettlementGroup,(int)((char *)&SettlementGroup-(char *)this),"SettlementGroup",sizeof(SettlementGroup),"SettlementGroup","S",0);
		m_Describe.SetupMember(Currency,(int)((char *)&Currency-(char *)this),"Currency",sizeof(Currency),"Currency","C",0);
		m_Describe.SetupMember(Deposit,(int)((char *)&Deposit-(char *)this),"Deposit",sizeof(Deposit),"Deposit","",10);
		m_Describe.SetupMember(Withdraw,(int)((char *)&Withdraw-(char *)this),"Withdraw",sizeof(Withdraw),"Withdraw","",10);
		m_Describe.SetupMember(Balance,(int)((char *)&Balance-(char *)this),"Balance",sizeof(Balance),"Balance","B",10);
		m_Describe.SetupMember(PreBalance,(int)((char *)&PreBalance-(char *)this),"PreBalance",sizeof(PreBalance),"PreBalance","",10);
		m_Describe.SetupMember(SortNumber,(int)((char *)&SortNumber-(char *)this),"SortNumber",sizeof(SortNumber),"SortNumber","",0);
		m_Describe.SetupMember(CanReduce,(int)((char *)&CanReduce-(char *)this),"CanReduce",sizeof(CanReduce),"CanReduce","",0);
		m_Describe.SetupMember(IsTrading,(int)((char *)&IsTrading-(char *)this),"IsTrading",sizeof(IsTrading),"IsTrading","",0);
		m_Describe.SetupMember(SettleSegment,(int)((char *)&SettleSegment-(char *)this),"SettleSegment",sizeof(SettleSegment),"SettleSegment","",0);
		m_Describe.SetupMember(MoneyTick,(int)((char *)&MoneyTick-(char *)this),"MoneyTick",sizeof(MoneyTick),"MoneyTick","",10);
		m_Describe.SetupMember(ExchangeID,(int)((char *)&ExchangeID-(char *)this),"ExchangeID",sizeof(ExchangeID),"ExchangeID","",0);
		m_Describe.SetupMember(InstrumentID,(int)((char *)&InstrumentID-(char *)this),"InstrumentID",sizeof(InstrumentID),"InstrumentID","",0);
		m_Describe.SetupMember(LoanUse,(int)((char *)&LoanUse-(char *)this),"LoanUse",sizeof(LoanUse),"LoanUse","LU",10);
		m_Describe.SetupMember(LoanLimit,(int)((char *)&LoanLimit-(char *)this),"LoanLimit",sizeof(LoanLimit),"LoanLimit","",10);
		m_Describe.SetupMember(LoanBorrow,(int)((char *)&LoanBorrow-(char *)this),"LoanBorrow",sizeof(LoanBorrow),"LoanBorrow","LB",10);
		m_Describe.SetupMember(LoanDeposit,(int)((char *)&LoanDeposit-(char *)this),"LoanDeposit",sizeof(LoanDeposit),"LoanDeposit","LD",10);
		m_Describe.SetupMember(LoanBase,(int)((char *)&LoanBase-(char *)this),"LoanBase",sizeof(LoanBase),"LoanBase","",10);
		m_Describe.SetupMember(LoanRate,(int)((char *)&LoanRate-(char *)this),"LoanRate",sizeof(LoanRate),"LoanRate","",10);
		m_Describe.SetupMember(LoanHighBase,(int)((char *)&LoanHighBase-(char *)this),"LoanHighBase",sizeof(LoanHighBase),"LoanHighBase","",10);
		m_Describe.SetupMember(LoanHighRate,(int)((char *)&LoanHighRate-(char *)this),"LoanHighRate",sizeof(LoanHighRate),"LoanHighRate","",10);
		m_Describe.SetupMember(Remark,(int)((char *)&Remark-(char *)this),"Remark",sizeof(Remark),"Remark","RE",0);
		m_Describe.SetupMember(CurrValue,(int)((char *)&CurrValue-(char *)this),"CurrValue",sizeof(CurrValue),"CurrValue","V",10);
		m_Describe.SetupMember(HairCut,(int)((char *)&HairCut-(char *)this),"HairCut",sizeof(HairCut),"HairCut","",10);
		m_Describe.SetupMember(MaxValue,(int)((char *)&MaxValue-(char *)this),"MaxValue",sizeof(MaxValue),"MaxValue","",10);
		m_Describe.SetupMember(MarginRateGroup,(int)((char *)&MarginRateGroup-(char *)this),"MarginRateGroup",sizeof(MarginRateGroup),"","",0);
		m_Describe.SetupMember(PrivateEnd,(int)((char *)&PrivateEnd-(char *)this),"PrivateEnd",sizeof(PrivateEnd),"","",10);
		m_Describe.SetupMember(InsertTime,(int)((char *)&InsertTime-(char *)this),"InsertTime",sizeof(InsertTime),"InsertTime","",3);
		m_Describe.SetupMember(UpdateTime,(int)((char *)&UpdateTime-(char *)this),"UpdateTime",sizeof(UpdateTime),"UpdateTime","",3);
	}
...
public:
	...
	void DescribeMembers()
	{
		...
		m_Describe.SetupMember(SettlementPrice,(int)((char *)&SettlementPrice-(char *)this),"SettlementPrice",sizeof(SettlementPrice),"SettlementPrice","S",15);
		m_Describe.SetupMember(OpenPrice,(int)((char *)&OpenPrice-(char *)this),"OpenPrice",sizeof(OpenPrice),"OpenPrice","O",15);
		m_Describe.SetupMember(IsPubMarketData,(int)((char *)&IsPubMarketData-(char *)this),"IsPubMarketData",sizeof(IsPubMarketData),"","",0);
		m_Describe.SetupMember(InstrumentStatus,(int)((char *)&InstrumentStatus-(char *)this),"InstrumentStatus",sizeof(InstrumentStatus),"InstrumentStatus","B",0);
		m_Describe.SetupMember(Remark,(int)((char *)&Remark-(char *)this),"Remark",sizeof(Remark),"Remark","RE",0);
		m_Describe.SetupMember(BusinessNo,(int)((char *)&BusinessNo-(char *)this),"BusinessNo",sizeof(BusinessNo),"","",0);
		m_Describe.SetupMember(MarkedPriceTotal,(int)((char *)&MarkedPriceTotal-(char *)this),"MarkedPriceTotal",sizeof(MarkedPriceTotal),"","",6);
		m_Describe.SetupMember(MarkedPriceWeight,(int)((char *)&MarkedPriceWeight-(char *)this),"MarkedPriceWeight",sizeof(MarkedPriceWeight),"","",6);
		m_Describe.SetupMember(L25UpperPrice,(int)((char *)&L25UpperPrice-(char *)this),"L25UpperPrice",sizeof(L25UpperPrice),"","",15);
		m_Describe.SetupMember(L25LowerPrice,(int)((char *)&L25LowerPrice-(char *)this),"L25LowerPrice",sizeof(L25LowerPrice),"","",15);
		m_Describe.SetupMember(L25UpperPrice1,(int)((char *)&L25UpperPrice1-(char *)this),"L25UpperPrice1",sizeof(L25UpperPrice1),"","",15);
		m_Describe.SetupMember(L25LowerPrice1,(int)((char *)&L25LowerPrice1-(char *)this),"L25LowerPrice1",sizeof(L25LowerPrice1),"","",15);
		m_Describe.SetupMember(L25UpperPrice2,(int)((char *)&L25UpperPrice2-(char *)this),"L25UpperPrice2",sizeof(L25UpperPrice2),"","",15);
		m_Describe.SetupMember(L25LowerPrice2,(int)((char *)&L25LowerPrice2-(char *)this),"L25LowerPrice2",sizeof(L25LowerPrice2),"","",15);
		m_Describe.SetupMember(BidPrice1,(int)((char *)&BidPrice1-(char *)this),"BidPrice1",sizeof(BidPrice1),"BidPrice1","BP1",15);
		m_Describe.SetupMember(BidVolume1,(int)((char *)&BidVolume1-(char *)this),"BidVolume1",sizeof(BidVolume1),"BidVolume1","BV1",10);
		m_Describe.SetupMember(AskPrice1,(int)((char *)&AskPrice1-(char *)this),"AskPrice1",sizeof(AskPrice1),"AskPrice1","AP1",15);
		m_Describe.SetupMember(AskVolume1,(int)((char *)&AskVolume1-(char *)this),"AskVolume1",sizeof(AskVolume1),"AskVolume1","AV1",10);
		m_Describe.SetupMember(TheoryPrice,(int)((char *)&TheoryPrice-(char *)this),"TheoryPrice",sizeof(TheoryPrice),"TheoryPrice","TP",15);
		m_Describe.SetupMember(HighestPrice24,(int)((char *)&HighestPrice24-(char *)this),"HighestPrice24",sizeof(HighestPrice24),"HighestPrice24","H2",15);
		m_Describe.SetupMember(LowestPrice24,(int)((char *)&LowestPrice24-(char *)this),"LowestPrice24",sizeof(LowestPrice24),"LowestPrice24","L2",15);
		m_Describe.SetupMember(Volume24,(int)((char *)&Volume24-(char *)this),"Volume24",sizeof(Volume24),"Volume24","V2",8);
		m_Describe.SetupMember(Turnover24,(int)((char *)&Turnover24-(char *)this),"Turnover24",sizeof(Turnover24),"Turnover24","T2",8);
		m_Describe.SetupMember(OpenPrice24,(int)((char *)&OpenPrice24-(char *)this),"OpenPrice24",sizeof(OpenPrice24),"OpenPrice24","O2",15);
		m_Describe.SetupMember(Frequency,(int)((char *)&Frequency-(char *)this),"Frequency",sizeof(Frequency),"","",0);
		m_Describe.SetupMember(InsertTime,(int)((char *)&InsertTime-(char *)this),"InsertTime",sizeof(InsertTime),"","",3);
	}
...
public:
	...
	void DescribeMembers()
	{
		m_Describe.SetupMember(ExchangeID,(int)((char *)&ExchangeID-(char *)this),"ExchangeID",sizeof(ExchangeID),"ExchangeID","X",0);
		m_Describe.SetupMember(InstrumentID,(int)((char *)&InstrumentID-(char *)this),"InstrumentID",sizeof(InstrumentID),"InstrumentID","I",0);
		m_Describe.SetupMember(InstrumentName,(int)((char *)&InstrumentName-(char *)this),"InstrumentName",sizeof(InstrumentName),"InstrumentName","N",0);
		m_Describe.SetupMember(SettlementGroup,(int)((char *)&SettlementGroup-(char *)this),"SettlementGroup",sizeof(SettlementGroup),"SettlementGroup","",0);
		m_Describe.SetupMember(ProductGroup,(int)((char *)&ProductGroup-(char *)this),"ProductGroup",sizeof(ProductGroup),"ProductGroup","G",0);
		m_Describe.SetupMember(UnderlyingID,(int)((char *)&UnderlyingID-(char *)this),"UnderlyingID",sizeof(UnderlyingID),"UnderlyingID","",0);
		m_Describe.SetupMember(ProductClass,(int)((char *)&ProductClass-(char *)this),"ProductClass",sizeof(ProductClass),"ProductClass","",0);
		m_Describe.SetupMember(ProductType,(int)((char *)&ProductType-(char *)this),"ProductType",sizeof(ProductType),"ProductType","",0);
		m_Describe.SetupMember(StrikePrice,(int)((char *)&StrikePrice-(char *)this),"StrikePrice",sizeof(StrikePrice),"StrikePrice","",15);
		m_Describe.SetupMember(OptionsType,(int)((char *)&OptionsType-(char *)this),"OptionsType",sizeof(OptionsType),"OptionsType","",0);
		m_Describe.SetupMember(VolumeMultiple,(int)((char *)&VolumeMultiple-(char *)this),"VolumeMultiple",sizeof(VolumeMultiple),"VolumeMultiple","VM",10);
		m_Describe.SetupMember(StartTime,(int)((char *)&StartTime-(char *)this),"StartTime",sizeof(StartTime),"StartTime","",3);
		m_Describe.SetupMember(ExpireTime,(int)((char *)&ExpireTime-(char *)this),"ExpireTime",sizeof(ExpireTime),"ExpireTime","",3);
		m_Describe.SetupMember(PriceCurrency,(int)((char *)&PriceCurrency-(char *)this),"PriceCurrency",sizeof(PriceCurrency),"PriceCurrency","PC",0);
		m_Describe.SetupMember(ClearCurrency,(int)((char *)&ClearCurrency-(char *)this),"ClearCurrency",sizeof(ClearCurrency),"ClearCurrency","CC",0);
		m_Describe.SetupMember(IsInverse,(int)((char *)&IsInverse-(char *)this),"IsInverse",sizeof(IsInverse),"IsInverse","II",0);
		m_Describe.SetupMember(BaseCurrency,(int)((char *)&BaseCurrency-(char *)this),"BaseCurrency",sizeof(BaseCurrency),"BaseCurrency","BB",0);
		m_Describe.SetupMember(MarginPriceType,(int)((char *)&MarginPriceType-(char *)this),"MarginPriceType",sizeof(MarginPriceType),"MarginPriceType","",0);
		m_Describe.SetupMember(BasisPrice,(int)((char *)&BasisPrice-(char *)this),"BasisPrice",sizeof(BasisPrice),"BasisPrice","",15);
		m_Describe.SetupMember(MinOrderVolume,(int)((char *)&MinOrderVolume-(char *)this),"MinOrderVolume",sizeof(MinOrderVolume),"MinOrderVolume","MOV",10);
		m_Describe.SetupMember(MinOrderCost,(int)((char *)&MinOrderCost-(char *)this),"MinOrderCost",sizeof(MinOrderCost),"MinOrderCost","MOC",10);
		m_Describe.SetupMember(MaxOrderVolume,(int)((char *)&MaxOrderVolume-(char *)this),"MaxOrderVolume",sizeof(MaxOrderVolume),"MaxOrderVolume","",10);
		m_Describe.SetupMember(PriceTick,(int)((char *)&PriceTick-(char *)this),"PriceTick",sizeof(PriceTick),"PriceTick","PT",15);
		m_Describe.SetupMember(VolumeTick,(int)((char *)&VolumeTick-(char *)this),"VolumeTick",sizeof(VolumeTick),"VolumeTick","VT",10);
		m_Describe.SetupMember(ShowVolumeTick,(int)((char *)&ShowVolumeTick-(char *)this),"ShowVolumeTick",sizeof(ShowVolumeTick),"","",10);
		m_Describe.SetupMember(TradingModel,(int)((char *)&TradingModel-(char *)this),"TradingModel",sizeof(TradingModel),"","",0);
		m_Describe.SetupMember(DayStartTime,(int)((char *)&DayStartTime-(char *)this),"DayStartTime",sizeof(DayStartTime),"DayStartTime","",0);
		m_Describe.SetupMember(SortNumber,(int)((char *)&SortNumber-(char *)this),"SortNumber",sizeof(SortNumber),"SortNumber","",0);
		m_Describe.SetupMember(Remark,(int)((char *)&Remark-(char *)this),"Remark",sizeof(Remark),"Remark","RE",0);
		m_Describe.SetupMember(DefaultLeverage,(int)((char *)&DefaultLeverage-(char *)this),"DefaultLeverage",sizeof(DefaultLeverage),"DefaultLeverage","DL",8);
		m_Describe.SetupMember(PriceLimitValueMode,(int)((char *)&PriceLimitValueMode-(char *)this),"PriceLimitValueMode",sizeof(PriceLimitValueMode),"","",0);
		m_Describe.SetupMember(PriceLimitPrice,(int)((char *)&PriceLimitPrice-(char *)this),"PriceLimitPrice",sizeof(PriceLimitPrice),"","",0);
		m_Describe.SetupMember(PriceLimitUpperValue,(int)((char *)&PriceLimitUpperValue-(char *)this),"PriceLimitUpperValue",sizeof(PriceLimitUpperValue),"","",15);
		m_Describe.SetupMember(PriceLimitLowerValue,(int)((char *)&PriceLimitLowerValue-(char *)this),"PriceLimitLowerValue",sizeof(PriceLimitLowerValue),"","",15);
		m_Describe.SetupMember(MarginRateGroup,(int)((char *)&MarginRateGroup-(char *)this),"MarginRateGroup",sizeof(MarginRateGroup),"","",0);
		m_Describe.SetupMember(CFDGroup,(int)((char *)&CFDGroup-(char *)this),"CFDGroup",sizeof(CFDGroup),"","",0);
		m_Describe.SetupMember(FeeGroup,(int)((char *)&FeeGroup-(char *)this),"FeeGroup",sizeof(FeeGroup),"","",0);
		m_Describe.SetupMember(TradingRightGroup,(int)((char *)&TradingRightGroup-(char *)this),"TradingRightGroup",sizeof(TradingRightGroup),"","",0);
		m_Describe.SetupMember(MaxOpenInterest,(int)((char *)&MaxOpenInterest-(char *)this),"MaxOpenInterest",sizeof(MaxOpenInterest),"","",10);
		m_Describe.SetupMember(FundingRateGroup,(int)((char *)&FundingRateGroup-(char *)this),"FundingRateGroup",sizeof(FundingRateGroup),"","",0);
		m_Describe.SetupMember(InsertTime,(int)((char *)&InsertTime-(char *)this),"InsertTime",sizeof(InsertTime),"","",3);
		m_Describe.SetupMember(UpdateTime,(int)((char *)&UpdateTime-(char *)this),"UpdateTime",sizeof(UpdateTime),"","",3);
		m_Describe.SetupMember(MarkedPriceTimes,(int)((char *)&MarkedPriceTimes-(char *)this),"MarkedPriceTimes",sizeof(MarkedPriceTimes),"","",0);
	}
...
public:
	...
	void DescribeMembers()
	{
		m_Describe.SetupMember(SystemID,(int)((char *)&SystemID-(char *)this),"SystemID",sizeof(SystemID),"SystemID","",0);
		m_Describe.SetupMember(ZoneDate,(int)((char *)&ZoneDate-(char *)this),"ZoneDate",sizeof(ZoneDate),"ZoneDate","D",0);
		m_Describe.SetupMember(ZoneTime,(int)((char *)&ZoneTime-(char *)this),"ZoneTime",sizeof(ZoneTime),"ZoneTime","T",0);
		m_Describe.SetupMember(ZoneDays,(int)((char *)&ZoneDays-(char *)this),"ZoneDays",sizeof(ZoneDays),"ZoneDays","Z",0);
		m_Describe.SetupMember(CurrTime,(int)((char *)&CurrTime-(char *)this),"CurrTime",sizeof(CurrTime),"CurrTime","C",3);
		m_Describe.SetupMember(InsertTime,(int)((char *)&InsertTime-(char *)this),"InsertTime",sizeof(InsertTime),"InsertTime","InsertTime",3);
		m_Describe.SetupMember(UpdateTime,(int)((char *)&UpdateTime-(char *)this),"UpdateTime",sizeof(UpdateTime),"UpdateTime","U",3);
		m_Describe.SetupMember(TimeZone,(int)((char *)&TimeZone-(char *)this),"TimeZone",sizeof(TimeZone),"","TimeZone",0);
		m_Describe.SetupMember(LastTradeID,(int)((char *)&LastTradeID-(char *)this),"LastTradeID",sizeof(LastTradeID),"","LastTradeID",0);
		m_Describe.SetupMember(LastOrderID,(int)((char *)&LastOrderID-(char *)this),"LastOrderID",sizeof(LastOrderID),"","LastOrderID",0);
		m_Describe.SetupMember(LastAccountDetailID,(int)((char *)&LastAccountDetailID-(char *)this),"LastAccountDetailID",sizeof(LastAccountDetailID),"","LastAccountDetailID",0);
		m_Describe.SetupMember(LastTimeSortNo,(int)((char *)&LastTimeSortNo-(char *)this),"LastTimeSortNo",sizeof(LastTimeSortNo),"","LastTimeSortNo",0);
		m_Describe.SetupMember(LastBusinessNo,(int)((char *)&LastBusinessNo-(char *)this),"LastBusinessNo",sizeof(LastBusinessNo),"","LastBusinessNo",0);
	}
...
public:
	...
	void DescribeMembers()
	{
		m_Describe.SetupMember(ExchangeID,(int)((char *)&ExchangeID-(char *)this),"ExchangeID",sizeof(ExchangeID),"ExchangeID","",0);
		m_Describe.SetupMember(InstrumentID,(int)((char *)&InstrumentID-(char *)this),"InstrumentID",sizeof(InstrumentID),"InstrumentID","",0);
		m_Describe.SetupMember(Bar,(int)((char *)&Bar-(char *)this),"Bar",sizeof(Bar),"Bar","",0);
		m_Describe.SetupMember(InsertTime,(int)((char *)&InsertTime-(char *)this),"InsertTime",sizeof(InsertTime),"InsertTime","I",3);
		m_Describe.SetupMember(OpenPrice,(int)((char *)&OpenPrice-(char *)this),"OpenPrice",sizeof(OpenPrice),"OpenPrice","O",15);
		m_Describe.SetupMember(HighestPrice,(int)((char *)&HighestPrice-(char *)this),"HighestPrice",sizeof(HighestPrice),"HighestPrice","H",15);
		m_Describe.SetupMember(LowestPrice,(int)((char *)&LowestPrice-(char *)this),"LowestPrice",sizeof(LowestPrice),"LowestPrice","L",15);
...
public:
	...
	void DescribeMembers()
	{
		...
		m_Describe.SetupMember(CopyProfitRate,(int)((char *)&CopyProfitRate-(char *)this),"CopyProfitRate",sizeof(CopyProfitRate),"CopyProfitRate","CopyProfitRate",10);
		m_Describe.SetupMember(CopyProfit,(int)((char *)&CopyProfit-(char *)this),"CopyProfit",sizeof(CopyProfit),"CopyProfit","CopyProfit",10);
		m_Describe.SetupMember(FirstTradeID,(int)((char *)&FirstTradeID-(char *)this),"FirstTradeID",sizeof(FirstTradeID),"FirstTradeID","FID",0);
		m_Describe.SetupMember(LastTradeID,(int)((char *)&LastTradeID-(char *)this),"LastTradeID",sizeof(LastTradeID),"LastTradeID","LID",0);
		m_Describe.SetupMember(BusinessType,(int)((char *)&BusinessType-(char *)this),"BusinessType",sizeof(BusinessType),"BusinessType","BT",0);
		m_Describe.SetupMember(BusinessValue,(int)((char *)&BusinessValue-(char *)this),"BusinessValue",sizeof(BusinessValue),"BusinessValue","BV",0);
		m_Describe.SetupMember(Reserve,(int)((char *)&Reserve-(char *)this),"Reserve",sizeof(Reserve),"Reserve","Reserve",10);
		m_Describe.SetupMember(ReserveProfit,(int)((char *)&ReserveProfit-(char *)this),"ReserveProfit",sizeof(ReserveProfit),"ReserveProfit","ReserveProfit",10);
...
public:
	...
	void DescribeMembers()
	{
		...
		m_Describe.SetupMember(InsertTime,(int)((char *)&InsertTime-(char *)this),"InsertTime",sizeof(InsertTime),"InsertTime","InsertTime",3);
		m_Describe.SetupMember(UpdateTime,(int)((char *)&UpdateTime-(char *)this),"UpdateTime",sizeof(UpdateTime),"UpdateTime","UpdateTime",3);
		m_Describe.SetupMember(Priority,(int)((char *)&Priority-(char *)this),"Priority",sizeof(Priority),"","",0);
		m_Describe.SetupMember(TimeSortNo,(int)((char *)&TimeSortNo-(char *)this),"TimeSortNo",sizeof(TimeSortNo),"","",0);
		m_Describe.SetupMember(FrontNo,(int)((char *)&FrontNo-(char *)this),"FrontNo",sizeof(FrontNo),"FrontNo","FrontNo",0);
		m_Describe.SetupMember(PriceCurrency,(int)((char *)&PriceCurrency-(char *)this),"PriceCurrency",sizeof(PriceCurrency),"PriceCurrency","PriceCurrency",0);
		...
		m_Describe.SetupMember(BusinessNo,(int)((char *)&BusinessNo-(char *)this),"BusinessNo",sizeof(BusinessNo),"BusinessNo","BusinessNo",0);
		m_Describe.SetupMember(Tradable,(int)((char *)&Tradable-(char *)this),"Tradable",sizeof(Tradable),"","",0);
		m_Describe.SetupMember(SettlementGroup,(int)((char *)&SettlementGroup-(char *)this),"SettlementGroup",sizeof(SettlementGroup),"","",0);
		m_Describe.SetupMember(PosiDirection,(int)((char *)&PosiDirection-(char *)this),"PosiDirection",sizeof(PosiDirection),"PosiDirection","PosiDirection",0);
		...
		m_Describe.SetupMember(Position,(int)((char *)&Position-(char *)this),"Position",sizeof(Position),"Position","Position",10);
		m_Describe.SetupMember(UserID,(int)((char *)&UserID-(char *)this),"UserID",sizeof(UserID),"UserID","U",0);
		m_Describe.SetupMember(LastPriceByInsert,(int)((char *)&LastPriceByInsert-(char *)this),"LastPriceByInsert",sizeof(LastPriceByInsert),"","",15);
		m_Describe.SetupMember(BidPrice1ByInsert,(int)((char *)&BidPrice1ByInsert-(char *)this),"BidPrice1ByInsert",sizeof(BidPrice1ByInsert),"","",15);
		m_Describe.SetupMember(AskPrice1ByInsert,(int)((char *)&AskPrice1ByInsert-(char *)this),"AskPrice1ByInsert",sizeof(AskPrice1ByInsert),"","",15);
		m_Describe.SetupMember(Available,(int)((char *)&Available-(char *)this),"Available",sizeof(Available),"Available","Available",10);
		m_Describe.SetupMember(CreateTime,(int)((char *)&CreateTime-(char *)this),"CreateTime",sizeof(CreateTime),"","",0);
	}
